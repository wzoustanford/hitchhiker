...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Extract LLEF data elementwise')
    parser.add_argument('--filename', type=str, 
                        default='model_data_single_step_trainingtimelength360d_buyselltimelength25d_training_data_start_date_2020_03_25_test_data_start_date_2020_04_26_newsFeaturesTrue_alpacafracfiltered.pkl',
                        help='Pickle filename to process')
    ...
    for ticker_idx in range(len(D['trainFeature'])):
        ...
        while batch_idx < batch_size: 
            ...
            if eval_score_int is None: 
                ...
                rb_tuple = (filename, filtered_count, ticker_idx, batch_idx, ticker, messages, assistant_response, eval_score_int, r)
                print(f"storing filtered_count:{filtered_count}, ticker_idx:{ticker_idx}, batch_idx:{batch_idx}, ticker:{ticker}, eval_score_int:{eval_score_int}, r:{r}")
